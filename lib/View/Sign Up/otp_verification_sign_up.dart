import 'package:dentilligence/View/Sign%20Up/success_screen.dart';
...
class _SignUpVerifyOtpPageState extends State<SignUpVerifyOtpPage> {
  ...
  void dispose() {
    ...
    for (var controller in _controller.otpControllers) controller.dispose();
    super.dispose();
  }

  void _checkAllFieldsFilled() {
    setState(() {
      _allFieldsFilled = _controller.otpControllers.every((c) => c.text.isNotEmpty);
    });
  }
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          counterText: "",
          filled: true,
          fillColor: _controller.otpControllers[index].text.isNotEmpty || 
